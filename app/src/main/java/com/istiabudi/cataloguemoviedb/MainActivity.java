...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            bundle.putString(NowPlayingFragment.EXTRAS_MOVIE,"Camera");
            fragment.setArguments(bundle);

//            Intent Upcoming = new Intent( MainActivity.this, UpcomingFragment.class );
//            startActivity( Upcoming );
            // Handle the camera action
        } else if (id == R.id.nav_gallery) {
            title = "UPCOMING";
            fragment = new UpcomingFragment();
            bundle.putString(UpcomingFragment.EXTRAS_MOVIE,"Camera");
            fragment.setArguments(bundle);

        } else if (id == R.id.nav_slideshow) {
            title = "FAVORITE";
            fragment = new FaveFragment();
            bundle.putString(FaveFragment.EXTRAS_MOVIE,"Camera");
            fragment.setArguments(bundle);

        } else if (id == R.id.nav_manage) {
            title = "SEARCHING";
            fragment = new SearchFragment();
            bundle.putString(SearchFragment.EXTRAS_MOVIE,"Camera");
            fragment.setArguments(bundle);
